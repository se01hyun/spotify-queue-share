...
export default function Home() {
  ...
  // 세션 동기화 활성화 (Hooks는 항상 early return 전에 호출)
  useSessionSync({ 
          ...
          <div className="container mx-auto px-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <Link href="/?welcome=1" className="text-2xl font-bold bg-gradient-to-r from-green-400 to-blue-500 bg-clip-text text-transparent hover:opacity-90 transition-opacity">
                  SpotifySync
                </Link>
                {sessionCode && (
